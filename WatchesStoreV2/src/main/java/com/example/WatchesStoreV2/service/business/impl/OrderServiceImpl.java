...
import com.example.WatchesStoreV2.entity.*;
import com.example.WatchesStoreV2.helper.payment.PaymentService;
import com.example.WatchesStoreV2.mapper.OrderMapper;
import com.example.WatchesStoreV2.mapper.ProductItemMapper;
import com.example.WatchesStoreV2.mapper.UserMapper;
import com.example.WatchesStoreV2.repository.OrderRepository;
import com.example.WatchesStoreV2.service.business.OrderService;
import com.example.WatchesStoreV2.service.component.*;
...
public class OrderServiceImpl implements OrderService {
    ...
    public String createOrder(OrderRequest orderReq, ObjectId userId) {
        ...
        try {
            ...
            ProfileOrder profileOrder = UserMapper.mapProfileOrder(user);
